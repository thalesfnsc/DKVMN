...
def test_one_dataset(params, file_name, test_q_data, test_qa_data, best_epoch, save_preds=False):
    ...
    test_net.init_params(arg_params=arg_params, aux_params=aux_params,
                         allow_missing=False)
    test_loss, test_accuracy, test_auc = test(test_net, params, test_q_data, test_qa_data, label='Test', save_preds=save_preds)
    print("\ntest_auc\t", test_auc)
...
if __name__ == '__main__':
    ...
    dataset = "errex"  # synthetic / assist2009_updated / assist2015 / KDDal0506 / STATICS
    ...
    if dataset == "assist2009_updated":
        ...
        parser.add_argument('--data_dir', type=str, default='/content/DKVMN/data/errex', help='data directory')
        parser.add_argument('--data_name', type=str, default='errex', help='data set name')
        parser.add_argument('--load', type=str, default='/content/DKVMN/data/errex', help='model file to load')
        parser.add_argument('--save', type=str, default='/content/DKVMN/data/errex/checkpoints', help='path to save model')
    ...
    if not params.test:
        ...
        if params.train_test:
            ...
            import mappings
            translation_data = mappings.load_data('''C:\\Users\\Richard\\DKVMN\\data\\decimal\\Data for DKT v2 Skill matrix.csv''')
            mappings.melt(params, translation_data)
            #pdb.set_trace()
